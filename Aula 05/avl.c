...
/*----------Inserção para o exercicio 2 (int) ------------*/
...
/*----------Inserção para o exercicio 3 (string) ------------*/
Arvore* inserir (Arvore *a, char chave[10]) {
   if (a == NULL){
       a = (No*)malloc(sizeof(No));
       for (int i = 0; i < 10; i++)
            a->chave[i] = chave[i];
...
//para a realização do exercicio 2, a chave foi trocada por int.
